...
To distinguish higher-order effects and operations from algebraic effects and operations, we write them with an \el{!} suffix. For example, a higher-order \el{Except!} effect is written \el{Except!}, and its \el{catch} operations is written \el{catch!}.

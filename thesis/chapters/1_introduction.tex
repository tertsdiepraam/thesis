...
\paragraph{Artefact}
The artefact accompanying this thesis contains a full prototype implementation for Elaine, written in Haskell. The \code{README.md} file contains instructions for building and executing the interpreter.\todo{Write that README.md}
